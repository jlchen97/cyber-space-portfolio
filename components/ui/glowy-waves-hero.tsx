...
const highlightPills = ["Robotics", "Aerospace", "Mechanical"] as const;

const heroStats: { label: string; value: string }[] = [
  { label: "Projects logged", value: "08" },
  { label: "Hyperloop seasons", value: "04" },
...
export function GlowyWavesHero() {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Project archive hero"
    >
      <canvas
        ref={canvasRef}
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 text-center md:px-8 lg:px-12">
        ...
        >
          <motion.div
            ...
            className="mb-6 inline-flex items-center gap-2 rounded-full border border-border/40 bg-background/60 px-4 py-2 font-label-caps text-xs uppercase tracking-[0.3em] text-foreground/70 dark:border-border/60 dark:bg-background/70 dark:text-foreground/80"
          >
          ...
          <motion.h1
            variants={itemVariants}
            className="mb-6 font-display text-4xl font-semibold tracking-tight text-foreground md:text-6xl lg:text-7xl"
          >
          ...
          >
            Eight projects across robotics, aerospace, marine, and design —
            hardware built end-to-end, from concept to functioning prototype.
          </motion.p>
          ...
          >
            <Button
              asChild
              size="lg"
              className="group gap-2 rounded-full px-8 font-label-caps text-base uppercase tracking-[0.2em]"
            >
              <Link href="#archive">
                Browse Archive
                <ArrowRight
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="rounded-full border-border/40 bg-background/60 px-8 font-label-caps text-base uppercase tracking-[0.2em] text-foreground/80 backdrop-blur transition-all hover:border-border/60 hover:bg-background/70 dark:border-border/50 dark:bg-background/40 dark:text-foreground/70 dark:hover:border-border/70 dark:hover:bg-background/50"
            >
          ...
          <motion.ul
            variants={itemVariants}
            className="mb-12 flex flex-wrap items-center justify-center gap-3 font-label-caps text-xs uppercase tracking-[0.3em] text-foreground/70 dark:text-foreground/80"
          >
          ...
          >
            {heroStats.map((stat) => (
              <motion.div
                ...
                className="space-y-1"
              >
                <div className="font-label-caps text-xs uppercase tracking-[0.3em] text-foreground/50 dark:text-foreground/60">
                  {stat.label}
                </div>
